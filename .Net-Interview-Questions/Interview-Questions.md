...
>
> **Инкапсуляция** - объединение данных иметодов их обработки в одном модуле. При инкапсуляции часть данных может скрываться от доступа извне. Позволяет обеспечить целостность данных, за счет чего повышает надежность системы.
> 
