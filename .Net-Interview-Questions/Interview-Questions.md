...
> * Наследование "has a" - взаимосвязь, в котором один объект принадлежит (является частью) другому объекту
 и подчиняется правилам принадлежности.
...
> Экземпляры такого класса создать нельзя.
> Ограничения:
