...
- В чем разница между типом-значением и типом-ссылкой? - Переменные типа значения хранят в себе значение. Переменные ссылочного типа хранят в себе лишь ссылку, которая указывает на конкретный участок памяти, выделенный под объект.
