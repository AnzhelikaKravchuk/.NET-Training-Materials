...
- Набор целочисленных зачений храниться в виде массива строк, которые являются представлением целого числа в p-ичной (2<=p<=16) системе счисления. Получить набор целочисленных значений.
