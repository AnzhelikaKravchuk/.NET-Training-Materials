...
- Набор целочисленных зачений хранится в виде массива строк, каждая из которых является представлением целого числа в p-ичной (2<=p<=16) системе счисления. Получить набор целочисленных значений.
